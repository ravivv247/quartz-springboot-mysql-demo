        ...
        if (jobInfoList != null) {
            ...
            jobInfoList.forEach(jobInfo -> {
                try {
                    ...
                    System.out.println("Class Not Found - {}"+ jobInfo.getJobClass()+ e);
    ...
    public boolean unScheduleJob(String jobName) {
        try {
            return schedulerFactoryBean.getScheduler().unscheduleJob(new TriggerKey(jobName));
        	 ...
        	 System.out.println("Failed to un-schedule job - {}"+ jobName+ e);
            return false;
        }
    }
    ...
    public boolean deleteJob(SchedulerJobInfo jobInfo) {
        try {
            return schedulerFactoryBean.getScheduler().deleteJob(new JobKey(jobInfo.getJobName(), jobInfo.getJobGroup()));
        	 ...
        	 System.out.println("Failed to delete job - {}"+ jobInfo.getJobName()+ e);
            return false;
        }
    }
